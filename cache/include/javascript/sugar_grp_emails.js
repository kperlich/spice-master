    		  ...
    		  this.customImageFormatter = function(elLiner, oRecord, oColumn, oData) {
   					...
   					if(!is_group)
   					{
    		  			if(oColumn.key == 'edit')
    		  			{
    		  				...
    		  				imgSrc = 'index.php?entryPoint=getImage&amp;themeName=SpiceTheme&amp;imageName='+oColumn.key+'_inline.gif';
    		  			}
