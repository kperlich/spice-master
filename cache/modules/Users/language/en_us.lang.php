...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Spice Mail Client:</b> Send emails using the email client in the Spice application.<br><b>External Mail Client:</b> Send email using an email client outside of the Spice application, such as Microsoft Outlook.',
  ...
  'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email).  This type cannot login through the Spice web interface.',
  ...
  'LBL_QUOTA_CARRYING' => 'Sales Quota',
  'LBL_QUOTA_SHORT' => 'Quota',
  'LBL_USERQUOTAS' => 'Sales Quotas',
  ...
  'LBL_PHONE' => 'Phone',
  'LBL_PICK_TZ_WELCOME' => 'Welcome to Spice.',
  ...
  'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the Spice web interface.',
  ...
  'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the Spice Plug-in for Microsoft&reg; Outlook&reg; and the Spice Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LNK_MANAGE_QUOTAS' => 'Define Quotas',
  ...
  'LBL_WIZARD_WELCOME_TITLE' => 'Welcome to Spice!',
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using Spice.',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using Spice.',
  ...
  'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use Spice!',
  'LBL_WIZARD_FINISH' => 'Click <b>Finish</b> below to save your settings and to begin using Spice. For more information on using Spice:<br /><br />
<table cellpadding=0 cellspacing=0>
<tr><td><!--not_in_theme!--><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.spicecrm.io" target="_blank"><b>Spice University</b></a><br>End-user and System Administrator Training and Resources</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="http://www.spicecrm.io" target="_blank"><b>Documentation</b></a><br>Product Guides and Release Notes</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/kb.png style="margin-right: 5px;"></td><td><a href="http://www.spicecrm.io" target="_blank"><b>Knowledge Base</b></a><br>Tips from SpiceCRM Support for performing common tasks and processes in Spice</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.spicecrm.io" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Spice Community to discuss topics of interest with each other and with SpiceCRM Developers</td></tr>
</table>',
  'LBL_WIZARD_FINISH1' => 'What would you like to do next?',
  'LBL_WIZARD_FINISH2' => 'Start Using Spice',
  ...
  'LBL_WIZARD_FINISH11' => 'Visit Spice University ',
  ...
  'LBL_WIZARD_FINISH17' => 'Tips from SpiceCRM Support for performing common tasks and processes in Spice ',
  'LBL_WIZARD_FINISH18' => 'Forums ',
  'LBL_WIZARD_FINISH19' => 'Forums dedicated to the Spice Community to discuss topics of interest with each other and with SpiceCRM Developers ',
  ...
  'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other Spice users.<br />Fields marked with <span class="required">*</span> are required.',
  'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in Spice.',
