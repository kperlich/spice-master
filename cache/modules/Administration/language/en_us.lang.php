...
$mod_strings = array (
  ...
  'ERR_SUGAR_DEPOT_DOWN' => 'The system is unable to connect to Spice Exchange for browsing and downloading packages.',
...
',
  ...
  'HEARTBEAT_MESSAGE' => '<BR>The Spice Updates mechanism allows your server to check to see if an update for your version of Spice is available.',
  'LBL_ACCEPT_TERMS' => 'Accept Terms and Conditions',
  'LBL_ACCEPT' => 'Accept',
  'LBL_ADMIN_SUGAR_SERVER' => 'Admin User Name:',
  'LBL_ADMIN_WIZARD_TITLE' => 'Admin Wizard',
  'LBL_ADMIN_WIZARD' => 'Easily setup your SpiceCRM system',
  ...
  'LBL_BACKUP_DIRECTORY_WRITABLE' => 'Must be writable by Spice',
  ...
  'LBL_BACKUP_INSTRUCTIONS_1' => 'The purpose of this tool is to assist in creating backups of the Spice application files. (Database backups should also be performed regularly. Please refer to your database vendor\'s documentation for information on how to backup your database.)',
  'LBL_BACKUP_INSTRUCTIONS_2' => 'To backup your Spice application files in a .zip file, enter the following information:',
  'LBL_BACKUP_RUN_BACKUP' => 'Run Backup',
  'LBL_BACKUP_TITLE' => 'Online Backups',
  'LBL_BACKUP' => 'Schedule backups to the Spice Online Data Vault.  Activate a system restoration from backup.',
  'LBL_BACKUPS_TITLE' => 'Backups',
  'LBL_BACKUPS' => 'Backup Spice files',
  'LBL_BROWSE' => 'Browse',
  'LBL_BUG_TITLE' => 'Bugs',
  ...
  'LBL_CONFIGURE_UPDATER' => 'Configure Spice Updates',
  ...
  'LBL_COULD_NOT_CONNECT' => 'Error: Could not connect to the Spice Server.
  ...
  'LBL_DIAGNOSTIC_CONFIGPHP' => 'SpiceCRM config.php',
  'LBL_DIAGNOSTIC_CUSTOMDIR' => 'SpiceCRM Custom directory',
  ...
  'LBL_DIAGNOSTIC_SUGARLOG' => 'SpiceCRM Log File',
  'LBL_DIAGNOSTIC_TITLE' => 'Diagnostic Tool',
  'LBL_DIAGNOSTIC_VARDEFS' => 'Spice schema output (VARDEFS)',
  ...
  'LBL_DOCUMENTATION' => 'View Spice documentation for administrators and end-users',
  'LBL_DONE' => 'Done',
  ...
  'LBL_IMPORT_CUSTOM_FIELDS_STRUCT' => ' Custom Field Structure (SpiceCustomFieldStruct.sug)',
  ...
  'LBL_LDAP_HELP_TXT' => 'When LDAP authentication is enabled, passwords can only be handled through LDAP. None of the Spice Password Management feature settings will apply.',
  'LBL_LDAP_SERVER_HOSTNAME' => 'Server:',
  'LBL_LDAP_SERVER_PORT' => 'Port Number:',
  'LBL_LDAP_ADMIN_USER' => 'User Name:',
  'LBL_LDAP_ADMIN_USER_DESC' => 'Used to search for the Spice user. [May need to be fully qualified] It will bind anonymously if not provided.',
  ...
  'LBL_LDAP_AUTO_CREATE_USERS_DESC' => 'If an authenticated user does not exist one will be created in Spice.',
  ...
  'LBL_MANUAL_VALIDATION3' => 'Step 2: Transfer the sugarkey.lic file to a system where you can access the internet with a web browser.   <br<br>Go to <a href="http://www.spicecrm.io">http://www.spicecrm.io</a>  and submit the sugarkey.lic file.  <br><br>The license validation web site will perform the validation immediately and return you the validation key file (sugarvalidationkey.lic) if the validation is successful.  Your browser should prompt you to save the file.  ',
  'LBL_MANUAL_VALIDATION4' => 'Step 3:  Transfer the validation key file (sugarvalidationkey.lic) back to the SpiceCRM system.  Import the validation key using this form below: ',
  ...
  'LBL_MASSAGE_MASS_EMAIL_DESC' => 'SpiceCRM 3.5.1+ requires an update to the Mass Email data.  Click "Begin Update" to continue.',
  ...
  'LBL_MI_IN_DASHLETS' => 'Installing Spice Dashlet ',
  'LBL_MI_UN_DASHLETS' => 'Uninstalling Spice Dashlet ',
  ...
  'LBL_MODULE_LOADER' => 'Add or remove Spice modules, themes, language packs and other extensions',
  ...
  'LBL_OFFLINE_CLIENT' => 'View Offline Clients that are connected to this Spice system',
  ...
  'LBL_PLUGINS_TITLE' => 'Spice Forge',
  'LBL_PLUGINS' => 'Get plug-ins and other Spice extensions.',
  ...
  'LBL_PROXY_ON_DESC' => 'Use a proxy to access external information such as Spice updates.',
  ...
  'LBL_REBUILD_DASHLETS_DESC_SHORT' => 'Rebuilds the Spice Dashlets cache file',
  'LBL_REBUILD_DASHLETS_DESC_SUCCESS' => 'Spice Dashlets cache file rebuilt.',
  'LBL_REBUILD_DASHLETS_DESC' => 'Removing Spice Dashlets cache and scanning known directories for Spice Dashlet files.',
  'LBL_REBUILD_DASHLETS_TITLE' => 'Rebuild Spice Dashlets',
  ...
  'LBL_REBUILD_EXPRESSIONS_DESC' => 'Rebuilds Spice Logic functions cache',
  'LBL_REBUILD_EXPRESSIONS_TITLE' => 'Rebuild Spice Logic Functions',
  ...
  'LBL_REPAIR_ORACLE_VARCHAR_DESC_LONG_1' => 'The following queries should be run against your database.  Run them manually with the client of your choice or click the "Commit" button to have SpiceCRM run the queries immediately.',
  ...
  'LBL_SEND_STAT' => '<B>Send Anonymous Usage Statistics</B> - If checked, Spice will send anonymous statistics about your installation to SpiceCRM Inc. every time your system checks for new versions.  This information will help us better understand how the application is used and guide improvements to the product.',
  ...
  'LBL_STUDIO' => 'Studio',
  'LBL_SUGAR_NETWORK_TITLE' => 'Spice Connect',
  'LBL_SUGAR_NETWORK_DESC' => 'Connect to the various SpiceCRM services where you can access the SpiceCRM forums and Spice Wiki, search FAQs (Frequently Asked Questions), download the latest Spice version, file and research reported bugs and request new features and more.',
  ...
  'LBL_SUGAR_UPDATE_TITLE' => 'Spice Updates',
  'LBL_SUGAR_UPDATE' => 'Check for the latest Spice version',
  'LBL_SUGARCRM_HELP' => 'SpiceCRM Help',
  'LBL_SUPPORT_TITLE' => 'Spice Support Portal',
  ...
  'LBL_UPDATE_TITLE' => 'Spice Updates',
  ...
  'LBL_UPGRADE_CONVERT_DISC_CLIENT' => 'Convert this Spice installation to an Offline Client',
  ...
  'LBL_UPGRADE_WIZARD' => 'Upload and install Spice upgrades',
  'LBL_UPGRADE' => 'Check and repair Spice',
  ...
  'LBL_USERS_DESC' => 'Create, edit, activate and deactivate users in Spice.',
...
',
  ...
  'ML_LBL_INSTALL_FROM_SERVER' => 'Install from Spice',
  ...
  'LBL_MODULEBUILDER_DESC' => 'Build new modules to expand the functionality of Spice',
  'LBL_SUGARPORTAL' => 'Spice Portal',
  'LBL_SUGARPORTAL_DESC' => 'Manage the Spice Portal',
  ...
  'LBL_QUICK_REPAIR_AND_REBUILD_DESC' => 'Repairs and rebuilds DB, Extensions, Vardefs, Spice Dashlets etc.',
  ...
  'LBL_QR_CBOX_CLEARDASHLET' => 'Clear Spice Dashlet Cache Data',
  ...
  'LBL_QR_CLEARDASHLET' => 'Clearing Spice Dashlet files from cache...done',
  ...
  'LBL_QR_CBOX_CLEARSUGARFEEDCACHE' => 'Clear Spice Feed Cache',
  'LBL_QR_CLEARSUGARFEEDCACHE' => 'Clearing Spice Feed Cache...done',
...
',
  ...
  'ML_PACKAGE_NOT_CONFIRM' => 'The package you are attempting to install does not conform to the policies established within the Spice Open Cloud or by your system administrator.',
  'ML_TO_RESOLVE' => 'To resolve this issue:',
  'ML_OBTAIN_NEW_PACKAGE' => 'Spice Open Cloud customers must obtain a new package from the package provider that addresses the issues described below.',
  'ML_RELAX_LOCAL' => 'If you are running Spice locally, you can relax your Module Loader restrictions to allow the package to be installed.',
  'ML_SUGAR_LOADING_POLICY' => 'The Spice Open Cloud package loading policies are detailed in the',
  'ML_SUGAR_KB' => 'SpiceCRM Knowledge Base',
  'ML_SUGAR_DZ' => 'SpiceCRM Developer Zone',
  'ML_AVAIL_RESTRICTION' => 'The available restrictions and exceptions are detailed in the',
  'ML_OVERRIDE_CORE_FILES' => 'Overriding of core SpiceCRM files is not allowed ',
  ...
  'LBL_SAML_HELP_TXT' => 'When SAML authentication is enabled, passwords can only be handled through SAML. None of the Spice Password Management feature settings will apply.',
  ...
  'LBL_GLOBAL_SEARCH_SETTINGS_TITLE' => 'Select the module(s) that users will be able to search against using the Global Search. <br><strong>CAUTION: if you configured Full Text Search these settings will be ignored and only FTS configuration will be considered.</strong>',
  ...
  'LBL_EAPM_SETTINGS_DESC' => 'Select external applications for which users can provide their account information in order to access from within Spice.',
  ...
  'LBL_CONFIGURE_SNIP_DESC' => 'Enable/disable the Spice Email Archiving Service',
  ...
  'LBL_FTS_HOST' => 'Host',
  'LBL_FTS_PORT' => 'Port',
  'LBL_FTS_TYPE_HELP' => 'Select the engine to use for full text searching. The system detects the engines that are supported and displays them within this list. Spice includes built-in support for the elasticsearch engine.',
...
3) Click Test to make sure Spice can connect to the search engine<br>
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_SPICETHEMECONFIG_LINK1_TITLE' => 'SpiceTheme Theme Settings',
  'LBL_SPICETHEMECONFIG_LINK1_DESCRIPTION' => 'general Theme Options',
  'LBL_SPICETHEMECONFIG_LINK2_TITLE' => 'Home-Pages Administration (BETA)',
  'LBL_SPICETHEMECONFIG_LINK2_DESCRIPTION' => 'publish Home Pages to a set of users (BETA)',
  ...
  'LBL_KDEPLOYMENT_LANDSCAPE' => 'Landscape manager',
  'LBL_KDEPLOYMENT_LANDSCAPE_DESCRIPTION' => 'Manage the System-Landscape for the Deployment process',
  'LBL_KDEPLOYMENT_DEPLOYMENTMANAGER' => 'Deployment Manager',
  'LBL_KDEPLOYMENT_DEPLOYMENTMANAGER_DESCRIPTION' => 'Manage Deployments for the Landscape-Systems',
  'LBL_KDEPLOYMENT_KRELEASEPACKAGES' => 'Release Packages',
  'LBL_KDEPLOYMENT_KRELEASEPACKAGES_DESCRIPTION' => 'Manage Release Packages',
  'LBL_KDEPLOYMENT_KCHANGEREQUESTS' => 'Change Requests',
  'LBL_KDEPLOYMENT_KCHANGEREQUESTS_DESCRIPTION' => 'Manage Change Requests',
  'LBL_KDEPLOYMENT_MAINTENANCEWINDOWS' => 'Maintenance Windows',
  'LBL_KDEPLOYMENT_MAINTENANCEWINDOWS_DESCRIPTION' => 'Manage Maintenance Windows',
);